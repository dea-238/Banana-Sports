        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-6 w-full">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="mt-4 flex flex-col gap-4">
              {[
                { src: '/images/playo.webp', alt: 'Playo', name: 'PLAYO', link: 'https://playo.co/venues/bangalore/banana-sports-mullur-bengaluru' },
                { src: '/images/km.png', alt: 'Khelomore', name: 'KHELOMORE', link: 'https://www.khelomore.com/sports-venues/bengaluru/banana-sports-off-sarjapur-road/2078' },
                { src: '/images/piplay.png', alt: 'Pi Play', name: 'PI PLAY', link: 'https://www.pi-play.com/' },
                { src: '/images/hudle.png', alt: 'Hudle', name: 'HUDLE', link: 'https://hudle.in/venues/banana-sports-sarjapur-road/638381' }
              ].map((item, index) => (
                <a 
                  key={index} 
                  href={item.link} 
          ...
          {/* Right Section - Added extra padding on the right */}
